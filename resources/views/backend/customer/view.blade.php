        ...
        <div class="col-md-4">
            <div class="card-hover-shadow card-border mb-3 card">
                    ...
                    <div class="dropdown-menu-header-inner bg-warning">
                        <div class="menu-header-content">
                            <div>
                                ...
                                <h6 class="menu-header-subtitle">{{ $customer->email }}</h6>
                            </div>
                            <div class="menu-header-btn-pane">
                                <a href="{{ route('admin.customer.edit', $customer->id) }}" class="mr-2 btn btn-dark btn-sm">Edit</a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="d-block text-right card-footer">
                    <a href="{{ route('admin.customer.index') }}" class="btn-shadow-primary btn btn-primary btn-lg">Back</a>
                </div>
            </div>
...
@push('after-scripts')
    ...
    <script>
        $(document).ready(function(){
            ...
            {
                $.ajax({
                    url:"{{ route('admin.customer.get-invoice', $customer->id) }}",
                    method:'GET',
                    data:{query:query},
                    dataType:'json',
