...
@section('title', app_name() . ' | Edit Customer')
        ...
        <div class="col-md-8 offset-2">
            <div class="main-card mb-3 card">
                <div class="card-body">
                    ...
                    {{ html()->modelForm($customer)->attribute('enctype', 'multipart/form-data')->open() }}
                    ...
                    <button type="submit" class="mt-1 btn btn-primary">Update Customer</button>
                    {{ html()->form()->close() }}
                </div>
            </div>
        </div>
