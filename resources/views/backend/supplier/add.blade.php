        ...
        <div class="col-md-8 offset-2">
            <div class="main-card mb-3 card">
                <div class="card-body">
                    ...
                    {{ html()->form('post', route('admin.supplier.insert'))->attribute('enctype', 'multipart/form-data')->open() }}
                    ...
                    <button type="submit" class="mt-1 btn btn-primary">Add New Supplier</button>
                    {{ html()->form()->close() }}
                </div>
            </div>
        </div>
